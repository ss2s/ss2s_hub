...
public:
    ...
    void connectWiFi(const char* ssid, const char* pass)
    {
        ...
        // wi-fi patch
        ///////////////////////////////////////////////////////////
        #define MY_CONNECT_WIFI_TIMEOUT 30000
        millis_time_t my_patch_wifi_started = BlynkMillis();
        ///////////////////////////////////////////////////////////

        // attempt to connect to Wifi network:
        while (status != WL_CONNECTED && (BlynkMillis() - my_patch_wifi_started < MY_CONNECT_WIFI_TIMEOUT)) {
