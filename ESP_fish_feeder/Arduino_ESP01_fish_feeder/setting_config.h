...
#define MEASURE_NUM 20                               // количество измерений
...
uint16_t servo_open_angle = 0;
uint16_t servo_close_angle = 90;
