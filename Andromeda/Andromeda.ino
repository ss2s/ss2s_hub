...
#include <Wire.h>    // подключаем библиотеку передачи данных через протокол I2C
...
float alfa1_3,alfa2_3, beta3, gamma3; 
float alfa1_4,alfa2_4, beta4, gamma4; 
float alfa1_5,alfa2_5, beta5, gamma5; 
...
/////////////////////////////////////////////////////////////////////////
bluetoothSetup();  // инициализация блютуз
/////////////////////////////////////////////////////////////////////////
...
//  difangle();
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////
  bluetoothLoop();  // основная функция взаимодействия с блютуз
  //////////////////////////////////////////////////////////////////////////////////////////////////

  ////////////////////////////////////////////////////////////////////////////////////////////////////
  bluetoothPrintVoltBat(/*батарея в процентах от 0 до 100*/);  // функция отправки состояния батареи
  ////////////////////////////////////////////////////////////////////////////////////////////////////
...
void updown()
{
  int x33=50; int y33=0; int z33=-50;
