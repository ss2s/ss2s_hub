...
// t1.end();              // up runing 14d
// t1.end(0, 0, 1, 30);   // up runing 1m 30s
// t1.end(0, 0, 30);      // up runing 30m
// t1.end(0, 1, 30);      // up runing 1h 30m
// t1.end(1, 1, 30);      // up runing 1d 1h 30m
// t1.end(1);             // up runing 1d
